 ...
 */
static const char* BITCOIN_PID_FILENAME = "sicashd.pid";
...
void Shutdown(InitInterfaces& interfaces)
{
    ...
    util::ThreadRename("sicash-shutoff");
...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-emergencystaking", "Sets the node to emergy staking in order to bypass any failures", ArgsManager::ALLOW_BOOL, OptionsCategory::OPTIONS);
    ...
    while (!fLoaded && !ShutdownRequested()) {
        ...
        do {
            ...
            try {
                ...
                pstorageresult.reset(new StorageResults(sicashStateDir.string()));
                if (fReset) {
