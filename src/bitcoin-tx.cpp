...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " sicash-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  sicash-tx [options] <hex-tx> [commands]  Update hex-encoded sicash transaction\n" +
            "or:     sicash-tx [options] -create [commands]   Create hex-encoded sicash transaction\n" +
            "\n";
