...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    genesis.hashStateRoot = uint256(h256Touint(dev::h256("e965ffd002cd6ad0e2dc402b8044de833e06b23127ea8c3d80aec91410771495"))); // sicash
    genesis.hashUTXORoot = uint256(h256Touint(dev::sha3(dev::rlp("")))); // sicash
    return genesis;
}
...
{
    const char* pszTimestamp = "26 Aug, 2020 UK worst hit among major economies";
...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000001588da875a3a3951783"); // sicash
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000054b076851886f682c5"); // sicash
        ...
        genesis = CreateGenesisBlock(1504695029, 49822, 0x1f00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x000056d2d78e2f86a09f58a67d937bcbf794fec44e34d1f3e40d04250a1b526a"));
        assert(genesis.hashMerkleRoot == uint256S("0x98d558298d3446ee0c70424ac156a13e65817a637ecbec4694a9d16855b4dac8"));
        ...
        checkpointData = {
            {
                {0, uint256S("000056d2d78e2f86a09f58a67d937bcbf794fec44e34d1f3e40d04250a1b526a")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x77cf352f6e3cd068240f7fd5c16df3c7b1ca77fb041b06000d5b48c9f530503a"));
        assert(genesis.hashMerkleRoot == uint256S("0x98d558298d3446ee0c70424ac156a13e65817a637ecbec4694a9d16855b4dac8"));
        ...
        checkpointData = {
            {
                {0, uint256S("77cf352f6e3cd068240f7fd5c16df3c7b1ca77fb041b06000d5b48c9f530503a")},
            }
        };
...
public:
    ...
    : CRegTestParams(args)
    {
        ...
        // SICASH have 500 blocks of maturity, increased values for regtest in unit tests in order to correspond with it
...
{
    return dev::eth::Network::sicashMainNetwork;
}
