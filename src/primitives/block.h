...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // sicash
        hashUTXORoot.SetNull(); // sicash
    ...
    virtual bool IsProofOfStake() const //sicash
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //sicash
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //sicash
    {
