...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SICASH");
    case mBTC: return QString("mSICASH");
    case uBTC: return QString::fromUtf8("μSICASH (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SICashs");
    case mBTC: return QString("Milli-SICashs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-SICashs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
