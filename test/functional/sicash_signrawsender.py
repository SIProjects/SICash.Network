...
class SICashSignRawSenderTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Now send some sicash to both addresses (one contract will increase its balance and the other one will throw),
